...
public class FromBLKConverter
{
	...
	protected void readHeader(RandomAccessFile file, DataMap map, int index) throws IOException, FormatMismatchException
	{
	...
	protected void readImageData(RandomAccessFile file, DataMap map) throws IOException
	{
		int i = 0;
	...
	protected void readBlock(RandomAccessFile file, DataMap map, int index, int blockx, int blocky) throws IOException
	{
		...
		short[] shortedData = ArrayUtilities.mergeElements_LE(rawdata, 0, rawdata.length);
