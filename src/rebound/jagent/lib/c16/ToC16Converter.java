...
public class ToC16Converter
{
	...
	public ToC16Notifee notifee;
	
	protected BufferedImage[] frames;
	protected byte[][] frameAlphaMaps;
	
	
	public ToC16Converter()
	{
		super();
	}
	...
	public void write() throws IOException, FormatMismatchException
	{
		...
		RandomAccessFile file = new RandomAccessFile(c16File, "rw");
	...
	protected void writeImageDatii(RandomAccessFile file, DataMap map) throws IOException, FormatMismatchException
	{
	...
	protected void writeImageData(RandomAccessFile file, int frameIndex, DataMap map) throws IOException, FormatMismatchException
	{
	...
	protected void writeRow(RandomAccessFile file, DataMap map, int frameIndex, int y) throws IOException, FormatMismatchException
	{
		...
		while (x < width)
		{
			...
			//Write run
			{
				...
				{
					//Write Color data
					byte[] split = ArrayUtilities.splitElements_LE(rawImageData, rowOffset+x, length);
					file.write(split);
				}
			}
